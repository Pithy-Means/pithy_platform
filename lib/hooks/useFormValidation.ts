...
import { BaseUserInfo, UserCategories, StudentInfo, JobSeekerInfo, EmployerInfo } from '@/types/schema';
...
export const useFormValidation = (formData: Partial<FormDataType>, currentStep: number) => {
    ...
    const validateStep = () => {
      switch (currentStep) {
        case 0: // Basic Info step
          const basicFields: (keyof BaseUserInfo)[] = ['firstname', 'lastname', 'email', 'password', 'phone', 'address'];
