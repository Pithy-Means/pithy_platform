...
const Header_description = () => {
  return (
    <div className="flex flex-col lg:items-start xl:items-start items-center space-y-4 w-full px-4 lg:px-0 xl:px-2 4k:px-6">
      ...
      <h1 className="text-xl sm:text-3xl lg:text-2xl xl:text-4xl 4k:text-6xl text-[#5AC35A] font-extrabold lg:text-start text-center">
        Unlock Your Dream Career.
      </h1>
      {/* Responsive paragraph */}
      <p className="text-base sm:text-lg md:text-lg lg:textxl xl:text-xl 4k:text-5xl lg:text-start text-center">
