  ...
  return (
    <div className="h-96 py-8">
      <Head>
        ...
        <meta
          name="description"
          content="Terms and conditions for using PITHY MEANS services."
        />
      </Head>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              terms and conditions of your use of the pithymeans.com website
              (“Website” or “Service”) and any of its related products and
              services (collectively, “Services”). This Agreement is legally
              binding between you (“User”, “you” or “your”) and PITHY MEANS LLC
              (“PITHY MEANS LLC”, “we”, “us” or “our”. In Africa, PITHY MEANS
              LLC is represented by PITHY MEANS AFRICA LIMITED). If you are
              ...
              and use the Website and Services. By accessing and using the
              ...
              PITHY MEANS LLC, even though it is electronic and is not
              physically signed by you, and it governs your use of the Website
              and Services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              You must be at least 16 years of age to use the Website and
              Services. By using the Website and Services and by agreeing to
              this Agreement you warrant and represent that you are at least 16
              years of age. In case the law of your country of residence or
              citizenship requires more than 16 years of age, please consider
              your country’s law for the mandatory age and other requirements as
              the minimum required age for this subscription. PITHY MEANS LLC
              will not be responsible if you don’t respect the law of your
              country.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed mt-4">
              The refund is only possible if payment has been made and effective
              and then fails to start accessing the services provided, and if
              this is due to the technical issue from our side. And the claim
              for refunding can only be made after 7 calendar days following the
              payment date, with proof of failing to access the online purchased
              services, and with proof of having not received technical support
              up to 5 days after having requested it to access the services.
              After having started benefiting the services, a refund is not
              possible, only technical support is available.
            </p>
            <p className="text-gray-600 leading-relaxed mt-4">
              In case you decide to invite people to this orientation and be our
              affiliate, you will be paid 10% as referral fees. You will be paid
              the amount once per calendar month, and when the total balance to
              be paid is equal or greater than USD 80 or its equivalent. Lower
              amounts or payment needs before the end of the month can be
              exceptionally analyzed for approval or rejection. The amount due
              for the ended month is paid in the ten calendar days following the
              ended calendar month. The requester will make a payment
              request/invoice on the name of the requester, mentioning the total
              cumulative amount of the service rendered (number of customers
              mobilized and corresponding referral fees), the total cumulative
              amount already paid, the balance to be paid for the closed
              calendar month, account details for payment (banking or any other
              information) for payment processing. This paragraph prevails in
              case of other different information.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              link and purchase an item, PITHY MEANS LLC will receive an
              ...
              of any resource which you access through a link on the Website.
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              immoral purpose or non-ethical and integrity use; or (j) to
              interfere with or circumvent the security features of the Website
              and Services, third party products and services, or the Internet.
              We reserve the right to terminate your use of the Website and
              Services for violating any of the prohibited uses. Any content or
              information that may be considered by the company as not aligned
              with its interest, vision or mission may be deleted any time,
              without any obligation of explanation.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              to you any intellectual property owned by PITHY MEANS LLC or third
              parties, and all rights, titles, and interests in and to such
              property will remain (as between the parties) solely with PITHY
              MEANS LLC. All trademarks, service marks, graphics and logos used
              in connection with the Website and Services, are trademarks or
              registered trademarks of PITHY MEANS LLC, PITHY MEANS AFRICA LTD
              or their licensors. Other trademarks, service marks, graphics and
              ...
              use any of PITHY MEANS LLC, PITHY MEANS AFRICA LTD, or third-party
              trademarks.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              will PITHY MEANS LLC, its affiliates, directors, officers,
              ...
              permitted by applicable law, the aggregate liability of PITHY
              MEANS LLC and its affiliates, officers, employees, agents,
              ...
              paid in cash by you to PITHY MEANS LLC for the prior one month
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              You agree to indemnify and hold PITHY MEANS LLC and its
              ...
              Website and Services or any wilful misconduct on your part.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              substantive and procedural laws of Wyoming, United States without
              ...
              hereof shall be the courts located in Wyoming, United States, and
              you hereby submit to the personal jurisdiction of such courts.
              <br />
              For Africa based people and institutions, disputes shall be
              governed by Ugandan law and Kampala based courts.
              <br />
