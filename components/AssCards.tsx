    ...
    <div className='flex flex-col lg:flex-row lg:space-x-4 space-y-6 lg:items-start items-center'>
        ...
        <div className='flex flex-col items-center lg:gap-0 space-y-2 lg:mb-64 mb-0'>
          ...
          <Card className='bg-white w-64'>
            <div className='bg-gradient-to-r from-[#5AC35A] to-[#00AE76] rounded-t-sm px-4 py-2'>
              <h3 className='text-lg font-extrabold text-black capitalize'>Take our assessment</h3>
            </div>
          ...
          <div className='text-center block lg:hidden'>
            <div className='h-6 w-6 bg-gradient-to-r from-[#5AC35A] to-[#00AE76] rounded-full p-4 text-white flex justify-center items-center text-center'>2</div>
          </div>
        </div>
        <img src='/assets/Arrow2.png' alt='Join' className='mb-[360px] lg:block hidden' />      
      </div>
      <div className='flex flex-col items-center lg:gap-0  space-y-2'>
        ...
        <div className='text-center'>
          <img src='/assets/Arrow 3.png' alt='' className='mt-[-160px] lg:block hidden'/>
        </div>
        <div className='block lg:hidden'>
          <img src='/assets/green.png' alt='Take' />
        </div>
        <div className='text-center block lg:hidden'>
          <div className='h-6 w-6 bg-gradient-to-r from-[#5AC35A] to-[#00AE76] rounded-full p-4 text-white flex justify-center items-center text-center'>3</div>
        </div>
      </div>      
      <div className='flex flex-col items-center'>
        <Card className='bg-white w-64 lg:mt-14 mt-0'>
          <div className='bg-gradient-to-r from-[#5AC35A] to-[#00AE76] rounded-t-sm px-4 py-2'>
            <h3 className='text-lg font-extrabold text-black capitalize'>Explore and take action</h3>
          </div>
