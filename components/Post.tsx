      ...
      const newPosts = Array(5)
        ...
        .map((_, index) => {
          ...
          return {
            ...
            time: "23 Minutes ago",
            content:
              "It’s intriguing, finding out that the career path, taken by most of that , freshly graduated student is as confusing as you could imagine due to the...",
    ...
    <div className="flex flex-col items-center overflow-y-scroll no-scrollbar">
      ...
      >
        {posts.map((post) => (
          <div
            key={post.id}
            className="flex flex-col bg-white  text-black px-6 justify-center  p-2 mx-6 mb-4"
          >
            <div className="">
              ...
              <div>
                <p className="text-base p-2 ">
                  I{post.content}
                  <span className="text-bold">...see more</span>
                </p>
              </div>
