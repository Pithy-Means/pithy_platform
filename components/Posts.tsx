                ...
                <div className="flex items-center justify-between">
                  ...
                  {loggedIn?.user_id === post.user_id && (
                    <HiOutlineDotsVertical
                      ...
                      onClick={() =>
                        post.post_id && toggleOptions(post.post_id)
                      }
                    />
                  )}
                </div>
              ...
              <div className="flex flex-col space-y-4 py-4">
                <div className="flex justify-between items-center">
                  <div className="flex space-x-2 items-center">
                    ...
                    <span className="font-normal">
                      {post.post_id
                        ? likeStatus[post.post_id]?.likeCount || 0
                        : 0}
                    </span>
                  </div>
                  <button
                ...
                <div className="flex space-x-8 items-center">
                  <div className="rounded-full bg-gray-300 text-white px-2 py-1 text-xl font-extrabold">
                    {loggedIn ? loggedIn.firstname.charAt(0).toUpperCase() : ""}
                  </div>
                  <button
                  ...
                  <button
                    onClick={() =>
                      post.post_id && setRepostingPostId(post.post_id)
                    }
                    className="flex flex-col space-y-1 items-center"
                  >
                    <p>
