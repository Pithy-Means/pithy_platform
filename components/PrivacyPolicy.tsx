...
export default function PrivacyPolicy() {
  return (
    <div className="h-96 py-8 px-4 sm:px-6 lg:px-8 text-black">
      <Head>
        <title>Privacy Policy - PITHY MEANS</title>
        <meta
          name="description"
          content="Privacy Policy for PITHY MEANS LLC and its related services."
        />
      </Head>
      ...
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <p className="mb-4">
          ...
          provide (“Personal Information”) on the pithymeans.com website
        ...
        <p className="mb-4">
          ...
          or “your”) and PITHY MEANS LLC (“PITHY MEANS LLC”, represented in
          Africa by “PITHY MEANS AFRICA LTD”, “we”, “us” or “our”). If you are
        ...
        <p className="mb-4">
          ...
          e-mail address, phone contact and address).
        </p>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            Account details (such as user name, unique user ID/email, password,
            etc)
          </li>
          <li>
        ...
        <h2 className="text-2xl font-bold mt-6 mb-4">Privacy of Children</h2>
        <p className="mb-4">
          ...
          you have reason to believe that a child under the age of 16 has
          ...
          Information from our Services. In case the law of your country of
          residence or citizenship requires more than 16 years of age, please
          consider your country’s law for the mandatory age and other
          requirements as the minimum required age. PITHY MEANS LLC will not be
          responsible if you don’t respect the law of your country.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          General Data Protection Regulation (GDPR) when handling Personal
          Information, unless we have entered into a data processing agreement
          with you in which case you would be the data controller and we would
          be the data processor.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          information is necessary for the performance of this Policy with you
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>Protection of someone’s life</li>
        </ul>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-6 mb-4">Payment Processing</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          brands like Visa, MasterCard, American Express, Discover and other
          accepted options. Sensitive and private data exchange happens over a
          ...
          secure of an environment as possible for Users. We will share payment
          data with the Payment Processors only to the extent necessary for the
        ...
        <h2 className="text-2xl font-bold mt-6 mb-4">Managing Information</h2>
        <p className="mb-4">
          ...
          your account, you can do so on the settings page of your account on
        ...
        <p className="mb-4">
          ...
          share any information with unaffiliated third parties. In case you
          have been invited by somebody to join us, the one who invited you is
          our affiliate partner and will be able to see the minimum of
          information on you like your name and phone contact, to be able to
          know how many mobilized people and how much many referral fees to be
          paid for. But the affiliates (Please note this if you are also playing
          this role) are not allowed to share or use any information. All what
          they can use it is to see who joined who paid, to be able to know the
          amount they will be paid. The breach of this will be considered as a
          violation of this policy and consequent measures will be taken.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          and storing your information where the main servers are based which
          can be a country other than your own. Such servers will be based in
          USA, Canada, UK, European Union or India. The transfer of your
          Personal Information to countries outside the European Union will be
          made only if you have explicitly consented to it or in the cases
          provided for by the GDPR and will be processed in your interest.
        </p>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            ...
            processing, and obtain a copy of your Personal Information
          ...
          <li>
            ...
            our collection and use of your Personal Information. If you are not
            satisfied with the outcome of your complaint directly with us, you
            ...
            protection authority in the EEA. This provision is applicable
            provided that your Personal Information is processed by automated
        ...
        <p className="mb-4">
          ...
          above, we have collected the categories of Personal Information listed
        ...
        <h2 className="text-2xl font-bold mt-6 mb-4">Advertisements</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-6 mb-4">Social media features</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-6 mb-4">Email marketing</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          you will continue to receive essential and transactional emails.
        </p>

        <h2 className="text-2xl font-bold mt-6 mb-4">Push notifications</h2>
        <p className="mb-4">
          We may offer push notifications to which you may also voluntarily
        ...
        <h2 className="text-2xl font-bold mt-6 mb-4">Affiliate links</h2>
        <p className="mb-4">
          We may engage in affiliate marketing and have affiliate links present
          on the Website and Services to be able to offer you related or
        ...
        <p className="mb-4">
          The Website and Services may contain links to other resources that we
          do not own or control. Please be aware that we are not responsible for
        ...
        <h2 className="text-2xl font-bold mt-6 mb-4">Information security</h2>
        ...
        <h2 className="text-2xl font-bold mt-6 mb-4">Data breach</h2>
        ...
        <p className="mb-4">
          ...
          by law. When we do, we will post a notice on the Website, send you an
          email.
        </p>

        <h2 className="text-2xl font-bold mt-6 mb-4">Changes and amendments</h2>
        ...
        <p className="mb-4">This document was last updated on February, 2025</p>
      </div>
    </div>
  );
}
