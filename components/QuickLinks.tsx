...
const QuickLinks: React.FC = () => {
  return (
    <div className="flex flex-col space-y-4 md:w-1/5 text-center justify-center w-full">
      <h3 className="text-lg font-bold text-white md:text-base lg:text2xl">Quick Links</h3>
      <nav className="flex flex-col space-y-2 ">
        <Link
          href="https://pithy-means.netlify.app/"
          className="text-[12px] md:text-base lg:text-base text-gray-600 hover:text-white transition duration-300 ease-in-out"
        >
          Home
        </Link>
        <Link
        ...
        <Link
          ...
          className="text-[12px] md:text-base lg:text-xl text-gray-600 hover:text-white transition duration-300 ease-in-out"
        >
          How It Works
        </Link>
        <Link
