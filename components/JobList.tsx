            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 w-full mx-auto">
              {jobs.map((job, index) => (
                ...
                >
                  {/* Hover glow effect */}
                  <div
                    className={`absolute inset-0 bg-green-500 rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500 transform ${hoverIndex === index ? "scale-105" : "scale-100"}`}
                  ></div>
          ...
          !loading && (
            <div className="flex flex-col justify-center items-center py-32 text-center">
              ...
              <p className="text-green-400 font-medium">
                Our AI is actively scanning for new opportunities
              </p>
              <p className="text-gray-400 mt-2 max-w-md">
                The matching algorithm is calibrating to your profile. Check
                back soon for personalized recommendations.
              </p>
