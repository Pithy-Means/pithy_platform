        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <Card className="bg-white p-5">
            <div className="flex justify-between py-2 items-center">
              <h3 className="lg:text-xl text-[14px] text-black capitalize font-extrabold">what is pithy means?</h3>
              <div className="lg:bg-[#5AC35A] lg:p-1 p-0 lg:rounded-full rounded-none bg-none">
                <ArrowLeft size={16} />
              </div>
            </div>
            <p className="text-black capitalize lg:text-base text-[12px]">Pithy means is career and business assessment platform helping students, professionals, and business adventurers find their most suitable study, professional, or business areas.</p>
          </Card>

          <Card className="bg-white pt-5 px-5 row-span-1/2 hidden lg:block">
            <div className="flex justify-between py-1">
              <h3 className="lg:text-xl text-lg text-black capitalize font-extrabold">how does pithy means work?</h3>
          ...
          <Card className="bg-white p-5">
            <div className="flex justify-between py-1">
              <h3 className="lg:text-xl text-[14px] text-black capitalize font-extrabold">Is pithy means trustworthy?</h3>
