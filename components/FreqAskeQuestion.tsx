  ...
  return (
    <div className="px-10 py-4 bg-white">
      <div className="flex flex-col space-y-4 lg:items-start items-center">
        ...
        <p className="capitalize text-black lg:text-start text-center text-sm sm:text-base lg:text-lg">
          Get answers to your questions about pithy means
        </p>
        <div className="w-full max-w-full overflow-x-auto">
          <div className="flex space-x-4 items-center scroll-scroll-smooth snap-mandatory snap-x text-sm sm:text-base lg:text-lg">
