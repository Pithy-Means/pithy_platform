...
const TitleDot: React.FC<TitleDotProps> = ({ title, className }) => {
  return (
    <div className="flex items-center justify-center md:justify-center lg:justify-start space-x-2 w-full">
      <h1 className={`text-xl sm:text-[6px] md:text-lg lg:text-3xl xl:text-4xl 4k:text-6xl md:text-center lg:text-start text-center text-black font-extrabold capitalize ${className}`}>
        {title}
      </h1>
