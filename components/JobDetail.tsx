...
import { FaTwitter, FaFacebook, FaTelegram, FaWhatsapp, FaEnvelope } from "react-icons/fa";
    ...
    <main className="w-full mx-auto p-8 mt-2 bg-gray-50 rounded-3xl shadow-2xl border border-gray-300 relative">
      ...
      <section className="mt-12">
        ...
        <p className="mt-4 text-lg text-gray-700">
          ...
          opportunities. Our team is committed to excellence, innovation, and making a
          difference in the industry. By joining us, you&apos;ll be part of a dynamic and
          inclusive workplace.
        </p>
      </section>
