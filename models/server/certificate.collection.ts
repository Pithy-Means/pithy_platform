...
export default function createCertificateCollection() {
  ...
  Promise.all([
    databases.createStringAttribute(db, certificateCollection, 'user_id', 100, true),
    databases.createStringAttribute(db, certificateCollection, 'course_id', 100, true),
    databases.createStringAttribute(db, certificateCollection, 'certificate_id', 100, true),
    databases.createDocument(db, certificateCollection, 'certificate', true),
    databases.createStringAttribute(db, certificateCollection, 'created_at', 100, false),
    databases.createStringAttribute(db, certificateCollection, 'updated_at', 100, false)
  ]);
}