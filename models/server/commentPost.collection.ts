...
export default async function createCommentCollection() {
  ...
  await databases.createCollection(db, postCommentCollection, postCommentCollection, [
  ...
  await Promise.all([
    databases.createStringAttribute(db, postCommentCollection, 'user_id', 100, true),
    databases.createStringAttribute(db, postCommentCollection, 'post_id', 100, true),
    databases.createStringAttribute(db, postCommentCollection, 'comment', 1000, true),
    databases.createStringAttribute(db, postCommentCollection, 'created_at', 100, false),
    databases.createStringAttribute(db, postCommentCollection, 'updated_at', 100, false)
  ]);
}