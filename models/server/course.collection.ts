...
export default async function createCourseCollection() {
  ...
  await Promise.all([
    ...
    databases.createStringAttribute(db, courseCollection, 'students', 100, false),
    databases.createStringAttribute(db, courseCollection, 'rating', 100, false),
    databases.createStringAttribute(db, courseCollection, 'reviews', 100, false),
    databases.createStringAttribute(db, courseCollection, 'enrolled', 100, false),
    databases.createStringAttribute(db, courseCollection, 'created_at', 100, false),
    databases.createStringAttribute(db, courseCollection, 'updated_at', 100, false)
  ]);
}