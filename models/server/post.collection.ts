...
export default async function createPostCollection() {
  ...
  await Promise.all([
    ...
    databases.createStringAttribute(db, postCollection, "content", 100000, true),
    databases.createStringAttribute(db, postCollection, "repost_of", 100, false),
    databases.createStringAttribute(db, postCollection, "user_comment", 10000, false),
