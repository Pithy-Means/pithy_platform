...
export default async function createUserCollection() {
  ...
  await Promise.all([
    ...
    databases.createStringAttribute(db, userCollection, "phone", 100, false),
    databases.createStringAttribute(db, userCollection, "city", 100, false),
    databases.createStringAttribute(db, userCollection, "earlier", 100, false),
    databases.createStringAttribute(db, userCollection, "country", 100, false),
    databases.createStringAttribute(db, userCollection, "referral_code", 100, false),
    databases.createIntegerAttribute(db, userCollection, "referral_points", false, 0),
    databases.createIntegerAttribute(db, userCollection, "earned_referral_fees", false, 0),
    databases.createStringAttribute(db, userCollection, "referral_by", 100, false),
    databases.createEnumAttribute(
      db,
      userCollection,
      "age",
      ["16-25", "26-35", "36-45", "46 and +"],
      true,
    ),
    databases.createEnumAttribute(
      db,
    ...
    databases.createEnumAttribute(
      ...
      userCollection,
      "education_level",
      ["High School", "Bachelor", "Diploma", "Masters", "PhD"],
      false,
    ),
    ...
    databases.createEnumAttribute(
      ...
      userCollection,
      "availability_status",
      ["immediately available", "to be confirmed"],
      false,
    ),
